...
- Uploads `benchmark-results.json`, `benchmark-dashboard.md`, and `benchmark-history.jsonl` as CI artifacts
- Posts the Markdown dashboard to the GitHub Actions step summary
